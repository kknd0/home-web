...
var login = function () {
    ...
    var _a = graphql_1.useLoginMutation(), login = _a[1];
    return (react_2["default"].createElement(Wapper_1.Wapper, { variant: 'small' },
        react_2["default"].createElement(formik_1.Formik, { initialValues: { usernameOrPhone: '', password: '' }, onSubmit: function (values, _a) {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 1:
                                ...
                                if ((_b = response.data) === null || _b === void 0 ? void 0 : _b.login.errors) {
                                    setErrors(toErrorMap_1.toErrorMap(response.data.login.errors));
                                }
                                else if ((_c = response.data) === null || _c === void 0 ? void 0 : _c.login.user) {
                                    router.push('/');
                                }
                                return [2 /*return*/];
                        }
            ...
            return (react_2["default"].createElement(formik_1.Form, null,
                react_2["default"].createElement(InputField_1.InputField, { name: 'usernameOrPhone', placeholder: '\u7535\u8BDD\u6216\u7528\u6237\u540D', label: '\u7535\u8BDD\u6216\u7528\u6237\u540D' }),
                react_2["default"].createElement(react_1.Box, { mt: 4 },
                    react_2["default"].createElement(InputField_1.InputField, { name: 'password', placeholder: 'password', label: 'password', type: 'password' })),
                react_2["default"].createElement(react_1.Button, { type: 'submit', colorScheme: 'teal', size: 'md', mt: 4, isLoading: isSubmitting }, "\u767B\u9646")));
        })));
};
